...
def get_project_version():
    version_path = os.path.join(base_dir, "faster_whisper_mic", "version.py")
    version = {}
...
setup(
    name="faster_whisper_mic",
    version=get_project_version(),
    license="MIT",
    description="Faster Whisper transcription with CTranslate2, modified for microphone input.",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    author="original by Guillaume Klein, modified by Robin Hylands",
    url="https://github.com/robin10125/faster_whisper_mic",
    classifiers=[
