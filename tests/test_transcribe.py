...
#import sys
# Add the directory containing transcribe.py to the Python path
#sys.path.append('/home/robin/Documents/faster-whisper-mic/faster-whisper-for-mic/faster_whisper_for_mic/')

from faster_whisper_for_mic import WhisperModel, decode_audio



whisper_model = WhisperModel("tiny.en", device="cpu", compute_type="int8")

# Use the whisper_model instance as needed
