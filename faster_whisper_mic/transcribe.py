...
from faster_whisper_mic.audio import decode_audio, pad_or_trim
from faster_whisper_mic.feature_extractor import FeatureExtractor
from faster_whisper_mic.tokenizer import _LANGUAGE_CODES, Tokenizer
from faster_whisper_mic.utils import download_model, format_timestamp, get_end, get_logger
from faster_whisper_mic.vad import (
    SpeechTimestampsMap,
    VadOptions,
    collect_chunks,
...
#VAD filter part as docstring for safe keeping for now
'''if vad_filter:
...
class WhisperModel:
    ...
    def vad_filter(
        ...
        """Applies the Voice Activity Detection (VAD) filter to an audio file.

        Arguments:
          audio: Path to the input file (or a file-like object), or the audio waveform.
          vad_parameters: Dictionary of Silero VAD parameters or VadOptions class (see available
            parameters and default values in the class `VadOptions`).
        Returns: tuple of np.ndarray and list[dict]
        """
